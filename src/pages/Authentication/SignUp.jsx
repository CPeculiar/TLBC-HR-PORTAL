        ...
        <div className="w-full max-w-[1400px] rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="flex flex-wrap items-center">
            ...
            <div className="hidden w-full lg:block lg:w-1/2">
              <div className="px-4 py-8 text-center sm:px-8 xl:px-12">
              <Link className="mb-2 inline-block" to="/">
                ...
                <p className="mb-8 text-base 2xl:px-20">
                Register with your correct information to be able to access the portal.
                </p>

                <span className="inline-block">
                  <svg
                    className="h-auto w-full max-w-[300px] sm:max-w-[350px]"
                    viewBox="0 0 350 350"
                    fill="none"
           ...
           <div className="w-full lg:w-1/2 lg:border-l-2 lg:border-stroke lg:dark:border-strokedark">
              <div className="w-full p-4 sm:p-8 xl:p-12">
                {/* Mobile Logo and Title - Improved mobile styling */}
