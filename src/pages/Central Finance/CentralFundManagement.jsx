...
const CentralFundManagement = () => {
  ...
  useEffect(() => {
    ...
    const fetchIncomingFunds = async () => {
      try {
        setIsLoading(true);
        const response = await axios.get('https://tlbc-platform-api.onrender.com/api/finance/central/fund/incoming/');
  ...
  const handleCreateFund = async () => {
    try {
      ...
      const response = await axios.post('https://tlbc-platform-api.onrender.com/api/finance/central/fund/create/', formData, {
        headers: {
  ...
  const handleFileUpload = async () => {
    try {
      ...
      const response = await axios.put(
        `https://tlbc-platform-api.onrender.com/api/finance/central/fund/${uploadFileReference.reference}/upload/`,
        formData,
        {
          headers: {
            'Content-Type': 'multipart/form-data'
 ...
 {/* Decline Confirmation Modal */}
  ...
  return (
<>
<Breadcrumb pageName="Central Fund Management"  className="text-black dark:text-white" />
