...
const CentralGivingList = () => {
  ...
  const fetchGivings = async () => {
    ...
    setError('');
    try {
        const url = 'https://tlbc-platform-api.onrender.com/api/finance/central/giving/admin/list/?limit=20';

      const response = await axios.get(
        'https://tlbc-platform-api.onrender.com/api/finance/central/giving/admin/list/?limit=20',
