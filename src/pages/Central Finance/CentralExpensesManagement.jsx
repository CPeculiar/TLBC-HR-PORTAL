         ...
         {/*Fetch initial data*/}
            ...
            const fetchAccounts = async () => {
                 ...
                 const fetchExpensesList = async (
                  url = 'https://tlbc-platform-api.onrender.com/api/finance/central/expense/list/?limit=10', ) => {
                  try {
                    setIsLoading(true);
      ...
      useEffect(() => {
        ...
        const handleExpenseProcessing = async (reference, type) => {
          try {
            ...
            let endpoint = '';
            if (type === 'approve') {
              endpoint = `https://tlbc-platform-api.onrender.com/api/finance/central/expense/${reference}/approve/`;
            } else if (type === 'decline') {
              endpoint = `https://tlbc-platform-api.onrender.com/api/finance/central/expense/${reference}/decline/`;
            }
        ...
        const handleFileUpload = async (reference, file) => {
          try {
            ...
            const response = await axios.patch(
              `https://tlbc-platform-api.onrender.com/api/finance/central/expense/${reference}/upload/`, 
              formData,
              {
                headers: {
                  'Content-Type': 'multipart/form-data',
            ...
            // Refresh expenses list
              const { data: refreshedData } = await axios.get('https://tlbc-platform-api.onrender.com/api/finance/central/expense/list/');
              setExpensesList(refreshedData.results);
...
// };
  ...
  return (
    ...
    <Breadcrumb pageName="Central Expenses Management" className="text-black dark:text-white p-4 lg:px-8" />
