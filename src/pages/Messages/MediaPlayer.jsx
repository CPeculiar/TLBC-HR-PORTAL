...
const MediaPlayer = () => {
  ...
  const disableDownload = true; // Forcing download to be disabled always
  ...
  // We're removing the original download function since we want to disable all downloads

  return (
    <div 
      ref={containerRef}
      className="bg-white shadow-lg rounded-lg overflow-hidden max-w-4xl mx-auto my-8"
