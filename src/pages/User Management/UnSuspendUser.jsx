...
const UnSuspendUser = () => {
  ...
  const handleunsuspend = async () => {
    ...
    try {
      const response = await axios.post(`https://tlbc-platform-api.onrender.com/api/users/${formData.username}/unsuspend/`, {  
      ...
      if (error.response) {
        if (error.response.status === 500) {
          setModalError("Unable to unSuspend, please contact Support");
  ...
  return (
    <>
      <Breadcrumb pageName="Unsuspend a User" className="text-black dark:text-white" />
              ...
              <div className="p-6.5">
                <div className="mb-4.5">
                  <label className="mb-2.5 block text-black dark:text-white">
                    Enter the Username of the member to be unsuspended
                  </label>
                  <input
                    type="text"
                    name="username"
      ...
      {showConfirmModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white rounded-lg p-6 text-center shadow-lg max-w-md w-full mx-4">
            <h2 className="text-xl font-medium text-black mb-4">Confirm Unsuspension</h2>
            <p className="mb-6 text-gray-600">Please enter your password to confirm Unsuspension of user: <span className="font-semibold">{formData.username}</span></p>
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white rounded-lg p-6 text-center shadow-lg max-w-md w-full mx-4">
            ...
            <p className="mb-6 text-gray-600">The user has been successfully Unsuspended.</p>
            <button
