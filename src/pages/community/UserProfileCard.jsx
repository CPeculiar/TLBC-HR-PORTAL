...
const UserProfileCard = ({ user, onClose }) => {
  ...
  <Card className="w-full max-w-xl mx-auto my-auto rounded-lg shadow-2xl relative dark:bg-boxdark">
    {/* Close Button */}
        <button
          onClick={onClose}
...
<div className="bg-gray-100 dark:bg-form-input px-1 flex justify-end space-x-4">
        <button
