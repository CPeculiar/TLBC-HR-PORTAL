  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 md:p-8">
      ...
      <div className="md:hidden flex justify-between items-center mb-4">
        <h1 className="text-2xl font-bold text-blue-600">Fund Management</h1>
        <button 
      ...
      <div className="flex">
        ...
        <div className={`
          ...
          md:block md:w-64 bg-white shadow-md rounded-lg p-4 mr-6 h-full fixed md:static z-40 w-64
        `}>
          <nav className="space-y-2">
            <button 
              onClick={() => {
                setActiveSection('create-fund');
            ...
            >
              <PlusCircle className="mr-2" /> Create Fund
            </button>

            <button 
              onClick={() => {
                setActiveSection('incoming-fund');
                setIsMobileMenuOpen(false);
              }}
              className={`w-full text-left p-3 rounded transition-colors flex items-center ${
            ...
            <button 
              onClick={() => {
                setActiveSection('outgoing-fund');
                setIsMobileMenuOpen(false);
              }}
              className={`w-full text-left p-3 rounded transition-colors flex items-center ${
      ...
      {uploadFileReference && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white p-6 rounded-lg shadow-xl max-w-sm w-full">
            ...
            <p className="text-center mb-4">File: {uploadFileReference.file.name}</p>
            <div className="flex space-x-4">
              <button 
