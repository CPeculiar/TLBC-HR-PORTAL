...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const hasUploadMessagePermission = () => userGroups.includes('Message admin');
  const hasMessagePermission = () => {
    // Check if either "View message" or "Upload message" exists in the userGroups array
  ...
  // Function to determine if a sidebar item should be shown
  const shouldShowSidebarItem = (item) => {
    switch(item) {
      case 'attendance':
        return permissions.attendance;  
      case 'expense':
        return permissions.expense;  
        case 'fund':
        return permissions.fund;  
        case 'giving':
        return permissions.giving;  
        case 'remittance':
        return permissions.remittance; 
        case 'topup':
        return permissions.topup;  
        case 'account':
        return permissions.account;  
      case 'group_users':
        return permissions.group_users;  
        case 'central_church':
        return permissions.central_church;  
        case 'message':
          return hasUploadMessagePermission() || isAdmin() || isSuperAdmin();  
        // return permissions.message;
        case 'userMessage':
        return hasMessagePermission() || isAdmin() || isSuperAdmin();  
      case 'zoneManagement':
...
{/* <!-- Menu Item Community Starts --> */}
              ...
              {/* <!-- Menu Item Community ends --> */}


{/* <!-- Menu Item Giving Starts --> */}
<SidebarLinkGroup
                activeCondition={
                  pathname === '/forms' || pathname.includes('forms')
                }
              ...
              {/* <!-- Menu Item Giving ends --> */}


{/* <!-- Menu Item Report Starts --> */}
<SidebarLinkGroup
                activeCondition={
                  pathname === '/forms' || pathname.includes('forms')
                }
              ...
              {/* <!-- Menu Item Report ends --> */}


{/* <!-- Menu Item Events Starts --> */}
      ...
      <SidebarLinkGroup
                          ...
                          <React.Fragment>
                            ...
                            >
                              ...
                              <li>
                                ...
                                {shouldShowSidebarItem('userMessage')  && (
                                <li>
                                  <NavLink
                                    to="/workersmeeting"
                                    className={({ isActive }) =>
            ...
            >
              ...
              >
                <path
                  d="M4 3H20C21.1 3 22 3.9 22 5V19C22 20.1 21.1 21 20 21H4C2.9 21 2 20.1 2 19V5C2 3.9 2.9 3 4 3ZM10 16L16 12L10 8V16ZM4 5V19H20V5H4Z"
                  fill="currentColor"
                />
              </svg>
              Messages
         ...
         <li>
          ...
          {(shouldShowSidebarItem('attendance') || 
            ...
            shouldShowSidebarItem('remittance') || 
                  shouldShowSidebarItem('topup') || 
                shouldShowSidebarItem('account') || 
            shouldShowSidebarItem('group_users') || 
         shouldShowSidebarItem('central_church') || 
         shouldShowSidebarItem('message') || 
        shouldShowSidebarItem('centralFinance') || 
        shouldShowSidebarItem('centralFinance') || 
        shouldShowSidebarItem('zoneManagement') || 
        shouldShowSidebarItem('userManagement') ||
       shouldShowSidebarItem('userPermissions') ||
                                      isAdmin() ||
                             isSuperAdmin()) && (
          <div>
            <h3 className="mb-4 ml-4 text-sm font-semibold text-bodydark2">
   ...
   {/* <!-- Menu Item Attendance Manager Starts --> */}
   {(shouldShowSidebarItem('attendance') ||  
                isAdmin() ||
              isSuperAdmin()) && (
   <SidebarLinkGroup
   ...
   <SidebarLinkGroup
              ...
              {/* <!-- Menu Item Finance Management ends --> */}
               ...
               {(shouldShowSidebarItem('central_church') || isSuperAdmin()) && (
   <SidebarLinkGroup
                activeCondition={
                  pathname === '/forms' || pathname.includes('forms')
                }
              ...
              {/* <!-- Menu Item Central Finance ends --> */}



{/* <!-- Menu Item Events Management Starts --> */}
   {(shouldShowSidebarItem('message') ||  
                isAdmin() ||
              isSuperAdmin()) && (
      <SidebarLinkGroup
      ...
      <SidebarLinkGroup
              ...
              {/* <!-- Menu Item LOLD Management Starts --> */}
   {(shouldShowSidebarItem('message') ||  
                isAdmin() ||
              isSuperAdmin()) && (
      <SidebarLinkGroup
              ...
              {/* <!-- Menu Item LOLD Management ends --> */}


        {/* <!-- Menu Item User Management Starts --> */}
        {(shouldShowSidebarItem('userManagement') || isSuperAdmin())  && (
        <SidebarLinkGroup
                        activeCondition={
                          pathname === '/forms' || pathname.includes('forms')
                        }
    ...
    {/* <!-- Menu Item User Permissions Starts --> */}
    {(shouldShowSidebarItem('group_users') ||  
              isSuperAdmin()) && (
      <SidebarLinkGroup
                      activeCondition={
              ...
              {/* <!-- Menu Item User Permissions ends --> */}


{/* <!-- Menu Item Zone Management Starts --> */}
{(shouldShowSidebarItem('zoneManagement') || isSuperAdmin()) && (
      <SidebarLinkGroup
                      activeCondition={
                        pathname === '/forms' || pathname.includes('forms')
                      }
