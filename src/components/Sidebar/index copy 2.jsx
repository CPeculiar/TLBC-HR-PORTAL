...
// close if the esc key is pressed
  ...
  // New function to check if user is superadmin
  const isSuperAdmin = () => {
    const storedRole = JSON.parse(localStorage.getItem('role'));
    return storedRole === 'superadmin';
  };

  // Function to determine if an admin section item should be shown
  const shouldShowAdminItem = (item) => {
    if (isSuperAdmin()) return true;
    
    switch(item) {
      case 'attendance':
        return isAdmin() && permissions.attendance;
      case 'finance':
        return isAdmin() && permissions.finance;
      case 'centralFinance':
        return isAdmin() && permissions.accounts;
      case 'zoneManagement':
        return isAdmin();
      case 'userManagement':
        return isSuperAdmin();
  ...
  <SidebarLinkGroup
   ...
   {shouldShowAdminItem('attendance') && (
   <SidebarLinkGroup
                activeCondition={
                  pathname === '/forms' || pathname.includes('forms')
                }
   ...
   <SidebarLinkGroup
              ...
              {/* <!-- Menu Item Finance Management ends --> */}
               ...
               {shouldShowAdminItem('centralFinance') && (
   <SidebarLinkGroup
                activeCondition={
                  pathname === '/forms' || pathname.includes('forms')
                }
...
{shouldShowAdminItem('zoneManagement') && (
<SidebarLinkGroup
                activeCondition={
                  pathname === '/forms' || pathname.includes('forms')
                }
...
{shouldShowAdminItem('userManagement') && (
<SidebarLinkGroup
                activeCondition={
                  pathname === '/forms' || pathname.includes('forms')
                }
